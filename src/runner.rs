    ...
    fn display_status(&self) {
        match &self.game {
            Some(g) => {
                ...
                A   {ai}   {bi}   {ci}   {di}   {ei}   {fi}   {gi}   {hi}   {ii}   {ji}\n
                B   {aj}   {bj}   {cj}   {dj}   {ej}   {fj}   {gj}   {hj}   {ij}   {jj}\n
                C   {ak}   {bk}   {ck}   {dk}   {ek}   {fk}   {gk}   {hk}   {ik}   {jk}\n
                D   {al}   {bl}   {cl}   {dl}   {el}   {fl}   {gl}   {hl}   {il}   {jl}\n
                E   {am}   {bm}   {cm}   {dm}   {em}   {fm}   {gm}   {hm}   {im}   {jm}\n
                F   {an}   {bn}   {cn}   {dn}   {en}   {ffn}   {gn}   {hn}   {iin}   {jn}\n
                G   {ao}   {bo}   {co}   {doo}   {eo}   {fo}   {go}   {ho}   {io}   {jo}\n
                H   {ap}   {bp}   {cp}   {dp}   {ep}   {fp}   {gp}   {hp}   {ip}   {jp}\n
                I   {aq}   {bq}   {cq}   {dq}   {eq}   {fq}   {gq}   {hq}   {iq}   {jq}\n
                J   {ar}   {br}   {cr}   {dr}   {er}   {fr}   {gr}   {hr}   {ir}   {jr}\n",
